...
type RawArtisan = {
  name: string; craft: string; cat: string; commune: string; type?: ArtisanData["type"];
};

const rawArtisans: RawArtisan[] = [
  // Art du cuir
  { name: "AP Sellerie, Anne Ponthenier", craft: "Sellière", cat: "Art du cuir", commune: "Vernier" },
  { name: "Atelier René René, Sylvia Blondin", craft: "Maroquinière", cat: "Art du cuir", commune: "Carouge" },
  { name: "L'Antre-Peaux, Chris Murner", craft: "Maroquinière", cat: "Art du cuir", commune: "Carouge" },
  { name: "Bracelets Protexo SA", craft: "Maroquinière", cat: "Art du cuir", commune: "Meinier" },
  { name: "Luxhous SA", craft: "Sellière", cat: "Art du cuir", commune: "Vernier" },
  { name: "Roger Truan SA", craft: "Gainière", cat: "Art du cuir", commune: "Carouge" },
  ...
  { name: "Cyril Sanglier", craft: "Sellier harnacheur", cat: "Art du cuir", commune: "Chêne-Bourg" },
  { name: "Orthethic", craft: "Bottier", cat: "Art du cuir", commune: "Carouge" },
  ...
  { name: "Atelier Gibson, Oran Gibson", craft: "Bijoutier • Joaillier • Sertisseur", cat: "Art de l'horlogerie et de la bijouterie", commune: "Carouge" },
  { name: "Atelier Galerie Igor Siebold", craft: "Bijoutier", cat: "Art de l'horlogerie et de la bijouterie", commune: "Carouge" },
  { name: "Atelier Laurent Jolliet", craft: "Bijoutier • Chaîniste", cat: "Art de l'horlogerie et de la bijouterie", commune: "Vernier" },
  { name: "Blandenier SA", craft: "Graveur • Emailleur • Sertisseur", cat: "Art de l'horlogerie et de la bijouterie", commune: "Genève" },
  ...
  { name: "Ingrid Schmidt Schmuck", craft: "Bijoutier", cat: "Art de l'horlogerie et de la bijouterie", commune: "Genève" },
  ...
  { name: "Samuel Gillioz", craft: "Horloger", cat: "Art de l'horlogerie et de la bijouterie", commune: "Plan-les-Ouates" },
  { name: "Stéphane Greco", craft: "Décorateur sur mouvement horloger", cat: "Art de l'horlogerie et de la bijouterie", commune: "Plan-les-Ouates" },
  { name: "Elisa Neveceral-Pantazopoulos", craft: "Bijoutière", cat: "Art de l'horlogerie et de la bijouterie", commune: "Genève" },
  { name: "Karine Dupont", craft: "Bijoutière-joaillère", cat: "Art de l'horlogerie et de la bijouterie", commune: "Carouge" },
  { name: "Traditech", craft: "Sertisseur", cat: "Art de l'horlogerie et de la bijouterie", commune: "Genève" },
  ...
  { name: "Dorothée Loustalot", craft: "Bijoutière • Design de bijoux", cat: "Art de l'horlogerie et de la bijouterie", commune: "Genève" },
  { name: "Sandy Rey", craft: "Bijoutière • Joaillière", cat: "Art de l'horlogerie et de la bijouterie", commune: "Genève" },
  { name: "Lucas Hage", craft: "Bijoutier", cat: "Art de l'horlogerie et de la bijouterie", commune: "Genève" },
  { name: "Atelier 9", craft: "Bijoutier", cat: "Art de l'horlogerie et de la bijouterie", commune: "Genève" },
  { name: "Cyril Seiler", craft: "Bijoutier • Joaillier", cat: "Art de l'horlogerie et de la bijouterie", commune: "Carouge" },

  // Art du textile
  { name: "Atelier Matin Bleu, Emmanuelle Bronzino", craft: "Tailleur • Couturier", cat: "Art du textile", commune: "Carouge" },
  { name: "Carolina Véliz, créatrice textile", craft: "Feutrière", cat: "Art du textile", commune: "Carouge" },
  { name: "Mercerie Catherine B", craft: "Brodeur", cat: "Art du textile", commune: "Genève" },
  { name: "Peter Kammermann", craft: "Tapissier", cat: "Art du textile", commune: "Carouge" },
  { name: "Revenga Chemisiers Genevois, Josefa Garcia Lozano", craft: "Couturier • Tailleur", cat: "Art du textile", commune: "Genève" },
  { name: "Atelier Contre-Jour", craft: "Fabricant d'abat-jour", cat: "Art du textile", commune: "Genève" },
  { name: "Lachenal SA", craft: "Courtepointier", cat: "Art du textile", commune: "Genève" },
  { name: "Laura Catignani", craft: "Modiste", cat: "Art du textile", commune: "Genève" },
  ...
  { name: "Jean-Robert Gase", craft: "Chapelier • Modiste", cat: "Art du textile", commune: "Genève" },
  ...
  { name: "Barro & Cie SA", craft: "Menuisier", cat: "Art du bois", commune: "Carouge" },
  { name: "Jérôme Blanc", craft: "Tourneur sur bois • Sculpteur sur bois", cat: "Art du bois", commune: "Carouge" },
  { name: "Marco Colucci Encadrement + Art", craft: "Encadreur", cat: "Art du bois", commune: "Genève" },
  { name: "Denis Schott & Fille", craft: "Encadreur d'art", cat: "Art du bois", commune: "Genève" },
  { name: "Gaspard Meier", craft: "Charpentier ornemaniste", cat: "Art du bois", commune: "Bernex" },
  { name: "Fanny Kopp", craft: "Graveuse sur bois", cat: "Art du bois", commune: "Vernier" },
  { name: "Marco Olivet", craft: "Encadreur d'art", cat: "Art du bois", commune: "Carouge" },
  { name: "Rosso encadrements", craft: "Encadreur", cat: "Art du bois", commune: "Chêne-Bourg" },
  { name: "Sakran SA — Pascal Sakran", craft: "Menuisier • Ebéniste", cat: "Art du bois", commune: "Carouge" },
  { name: "Olivier Veuthey", craft: "Menuisier • Ebéniste", cat: "Art du bois", commune: "Bernex" },
  { name: "Art & Maison SA", craft: "Parqueteur", cat: "Art du bois", commune: "Bellevue" },
  ...
  { name: "Sylvio Asseo", craft: "Sculpteur sur bois", cat: "Art du bois", commune: "Puplinge" },

  // Art du papier
  { name: "Atelier ABR Sàrl", craft: "Relieur • Doreur", cat: "Art du papier", commune: "Vernier" },
  { name: "Loutan & Cie SA", craft: "Imprimeur en sérigraphe", cat: "Art du papier", commune: "Genève" },
  { name: "Réhane Favereau", craft: "Découpeuse sur papier", cat: "Art du papier", commune: "Pregny-Chambésy" },
  { name: "Duo d'art", craft: "Imprimeur en sérigraphie", cat: "Art du papier", commune: "Vernier" },

  // Facture instrumentale
  { name: "Atelier de lutherie, Béatrice de Haller", craft: "Luthier", cat: "Art de la facture instrumentale", commune: "Carouge" },
  { name: "Maître Luthier François Lebeau", craft: "Luthier", cat: "Art de la facture instrumentale", commune: "Genève" },
  { name: "Pianos-Service P. Fuhrer", craft: "Facteur de pianos", cat: "Art de la facture instrumentale", commune: "Genève" },
  { name: "Bernard Bossert", craft: "Luthier du quatuor", cat: "Art de la facture instrumentale", commune: "Genève" },
  ...
  { name: "La Maison de Nathalie", craft: "Céramiste", cat: "Art de la terre", commune: "Puplinge" },
  { name: "Poterie Passion — Sylvie Cellerino", craft: "Céramiste", cat: "Art de la terre", commune: "Presinge" },
  { name: "Héloïse Ihne", craft: "Fabricante de compositions et décors végétaux stables et durables", cat: "Art de la terre", commune: "Carouge" },
  ...
  // Arts appliqués
  { name: "Atelier C1, Thierry Reverdin", craft: "Maquettiste", cat: "Arts appliqués", commune: "Genève" },
  { name: "Atelier d'Art, Jacky Riesen", craft: "Lustrier", cat: "Arts appliqués", commune: "Lancy" },
  { name: "Atelier JMS, Jean-Michel Staudhammer", craft: "Maquettiste", cat: "Arts appliqués", commune: "Chêne-Bourg" },
  { name: "Emmanuelle Zem Rohner", craft: "Peintre décorateur • Peintre en décor du patrimoine", cat: "Arts appliqués", commune: "Genève" },
  { name: "Finissimo Reliure — Alexis De Los Santos", craft: "Relieur", cat: "Arts appliqués", commune: "Carouge" },
  { name: "Yvan Hostettler", craft: "Calligraphe", cat: "Arts appliqués", commune: "Genève" },
  { name: "Patrick Reymond", craft: "Maquettiste", cat: "Arts appliqués", commune: "Veyrier" },
  ...
  { name: "L'Atelier de la Cire Genève", craft: "Cirière", cat: "Arts appliqués", commune: "Carouge" },
  { name: "Jean-Philippe Naef", craft: "Restaurateur d'objets anciens", cat: "Arts appliqués", commune: "Bardonnex" },

  // Art du verre
  { name: "Marina Buckel", craft: "Oculariste", cat: "Art du verre", commune: "Perly" },
  ...
  { name: "Atelier Comte", craft: "Tailleur de pierre", cat: "Art de la pierre", commune: "Bardonnex" },
  { name: "Michel Gillabert", craft: "Sculpteur sur pierre", cat: "Art de la pierre", commune: "Veyrier" },
  { name: "Philippe Cartan", craft: "Sculpteur sur pierre", cat: "Art de la pierre", commune: "Plan-les-Ouates" },
  { name: "Mello & Fils SA", craft: "Tailleur de pierre", cat: "Art de la pierre", commune: "Carouge" },
  { name: "Daniel Estevez", craft: "Marbrier", cat: "Art de la pierre", commune: "Satigny" },
  { name: "Béatrice Archinard", craft: "Sculpteure sur pierre", cat: "Art de la pierre", commune: "Genève" },
  { name: "Julien Joselon", craft: "Sculpteur sur pierre", cat: "Art de la pierre", commune: "Dardagny" },
  { name: "Artisan du Staff", craft: "Staffeur-stucateur ornemaniste", cat: "Art de la pierre", commune: "Meyrin" },

  // Art du métal
  { name: "Atelier Leckie, Anna Leckie", craft: "Graveuse taille-douce", cat: "Art du métal", commune: "Carouge" },
  { name: "Charles Roulin", craft: "Coutelier d'art", cat: "Art du métal", commune: "Bernex" },
  { name: "Cerutti Toitures SA", craft: "Ferblantier ornemaniste", cat: "Art du métal", commune: "Genève" },
  { name: "Métaloïd SA", craft: "Constructeur métallique", cat: "Art du métal", commune: "Genève" },
  { name: "Joshua Teegarden", craft: "Fondeur", cat: "Art du métal", commune: "Aire-la-Ville" },
  { name: "SwissArt Edition — David Chojnacki", craft: "Fondeur d'art", cat: "Art du métal", commune: "Jussy" },
  { name: "Olivier Murner SA", craft: "Constructeur métallique", cat: "Art du métal", commune: "Genève" },
  { name: "Art Kern", craft: "Ferronnier • Constructeur métallique", cat: "Art du métal", commune: "Genève" },

  // Conservation et restauration
  { name: "Hoffmann Art Management", craft: "Conservateur-restaurateur d'œuvres d'art", cat: "Art de la conservation et de la restauration", commune: "Lancy" },
  ...
  { name: "Orth & Fils SÀRL", craft: "Peintre décorateur • Restaurateur d'art", cat: "Art de la conservation et de la restauration", commune: "Genève" },
  { name: "Lucien Walker", craft: "Restaurateur de livres", cat: "Art de la conservation et de la restauration", commune: "Carouge" },
  ...
  { name: "Association pour le patrimoine industriel (API)", craft: "Typographe • Imprimeur sur presses anciennes • Relieur", cat: "Institutions culturelles", commune: "Genève", type: "institution_culturelle" },
  { name: "Atelier Genevois de Gravure Contemporaine (AGGC)", craft: "Graveur", cat: "Institutions culturelles", commune: "Genève", type: "institution_culturelle" },
  { name: "Comédie de Genève", craft: "Costumier", cat: "Institutions culturelles", commune: "Genève", type: "institution_culturelle" },
  ...
  { name: "Fondation Martin Bodmer", craft: "Technicien en conservation d'art", cat: "Institutions culturelles", commune: "Cologny", type: "institution_culturelle" },
  { name: "Grand Théâtre de Genève", craft: "Décorateur et accessoiriste costumes", cat: "Institutions culturelles", commune: "Genève", type: "institution_culturelle" },
  { name: "Muséum d'Histoire Naturelle", craft: "Taxidermiste", cat: "Institutions culturelles", commune: "Genève", type: "institution_culturelle" },
  ...
  { name: "Musée d'Art et d'Histoire", craft: "Conservateur-restaurateur", cat: "Institutions culturelles", commune: "Genève", type: "institution_culturelle" },
  { name: "Bibliothèque de Genève", craft: "Conservateur-restaurateur", cat: "Institutions culturelles", commune: "Genève", type: "institution_culturelle" },
  { name: "Théâtre de Carouge", craft: "Costumier", cat: "Institutions culturelles", commune: "Carouge", type: "institution_culturelle" },
  ...
  { name: "Musée International de la Réforme", craft: "Graveur • Imprimeur", cat: "Institutions culturelles", commune: "Genève", type: "institution_culturelle" },
  { name: "Collection des Moulages", craft: "Scénographe • Restaurateur", cat: "Institutions culturelles", commune: "Genève", type: "institution_culturelle" },
  { name: "Scènes du Grütli", craft: "Scénographe", cat: "Institutions culturelles", commune: "Genève", type: "institution_culturelle" },
  { name: "Ateliers de décors de théâtre", craft: "Fabricant de décors de spectacle", cat: "Institutions culturelles", commune: "Vernier", type: "institution_culturelle" },
  ...
  { name: "CFPne Lullier", craft: "Artisan fleuriste", cat: "Écoles formatrices", commune: "Jussy", type: "ecole_formatrice" },
  ...
  { name: "IPAC Design Genève", craft: "Mode, architecture intérieure et design graphique", cat: "Écoles formatrices", commune: "Vernier", type: "ecole_formatrice" },
...
export const artisans: ArtisanData[] = rawArtisans.map((r, i) => {
  const [lat, lng] = coords(r.commune);
  return {
    id: `art-${i + 1}`,
    name: r.name,
    slug: slug(r.name),
