...
const ArtisansMap = dynamic(() => import("@/components/map/ArtisansMap"), {
  ...
  loading: () => (
    <div className="w-full h-[400px] sm:h-[500px] rounded-xl bg-mag-cream/40 flex items-center justify-center">
      <p className="text-mag-gray">Chargement de la carte…</p>
    </div>
  ),
});
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-6 gap-4">
          ...
          <label className="flex items-center gap-2 text-sm">
            ...
            <select
              ...
              className="rounded-lg border border-mag-cream bg-white px-4 py-2.5 text-sm font-medium text-mag-dark focus:border-mag-red focus:outline-none focus:ring-2 focus:ring-mag-red/20"
            >
