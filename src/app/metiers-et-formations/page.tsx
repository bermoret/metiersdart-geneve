...
const metiersFormations: MetierFormation[] = [
  {
    ...
    formations: [
      { label: "Bijoutier CFC / Bijoutière CFC", url: "https://www.orientation.ch/fr/professions/bijoutier-iere-joaillier-iere-cfc" },
    ],
  ...
  },
  {
    ...
    formations: [
      { label: "Cordonnier CFC / Cordonnière CFC", url: "https://www.orientation.ch/fr/professions/cordonnier-iere-cfc" },
      { label: "Bottier-orthopédiste CFC / Bottière-orthopédiste CFC", url: "https://www.orientation.ch/fr/professions/bottier-iere-orthopediste-cfc" },
    ],
  ...
  },
  {
    ...
    formations: [
      { label: "Courtepointier CFC / Courtepointière CFC", url: "https://www.orientation.ch/fr/professions/courtepointier-iere-cfc" },
    ],
  ...
  },
  {
    ...
    formations: [
      { label: "Technologue en médias CFC", url: "https://www.orientation.ch/fr/professions/technologue-en-medias-cfc" },
    ],
  ...
  },
  {
    ...
    formations: [
      { label: "Céramiste CFC", url: "https://www.orientation.ch/fr/professions/ceramiste-cfc" },
    ],
  ...
  },
  {
    ...
    formations: [
      { label: "Confectionneur AFP / Confectionneuse AFP", url: "https://www.orientation.ch/fr/professions/confectionneur-euse-afp" },
      { label: "Créateur de vêtements CFC / Créatrice de vêtements CFC", url: "https://www.orientation.ch/fr/professions/createur-trice-de-vetements-cfc" },
    ],
    category: "Art du textile",
  },
  {
    ...
    formations: [
      { label: "Charpentier CFC / Charpentière CFC", url: "https://www.orientation.ch/fr/professions/charpentier-iere-cfc" },
    ],
  ...
  },
  {
    ...
    formations: [
      { label: "Doreur-encadreur CFC / Doreuse-encadreuse CFC", url: "https://www.orientation.ch/fr/professions/doreur-se-encadreur-se-cfc" },
      { label: "Conservateur-restaurateur HES / Conservatrice-restauratrice HES", url: "https://www.orientation.ch/fr/professions/conservateur-restaurateur-conservatrice-restauratrice" },
    ],
  ...
  },
  {
    ...
    formations: [
      { label: "Constructeur métallique CFC / Constructrice métallique CFC", url: "https://www.orientation.ch/fr/professions/constructeur-trice-metallique-cfc" },
    ],
  ...
  },
  {
    ...
    formations: [
      { label: "Créateur de vêtements CFC / Créatrice de vêtements CFC", url: "https://www.orientation.ch/fr/professions/createur-trice-de-vetements-cfc" },
      { label: "Costumier de théâtre / Costumière de théâtre", url: "https://www.orientation.ch/fr/formations/ecole-de-couture-fribourg/costumier-costumiere-de-theatre" },
    ],
    category: "Art du textile",
  },
  {
    ...
    formations: [
      { label: "Courtepointier CFC / Courtepointière", url: "https://www.orientation.ch/fr/professions/courtepointier-iere-cfc" },
      "Couturier d'intérieur AFP / Couturière d'intérieur AFP",
    ],
    category: "Art du textile",
  },
  {
    ...
    formations: [
      { label: "Coutelier CFC / Coutelière CFC", url: "https://www.orientation.ch/fr/professions/coutelier-iere-cfc" },
    ],
    category: "Art du métal",
  },
  {
  ...
  },
  {
    ...
    formations: [
      { label: "Designer d'objets horlogers", url: "https://www.orientation.ch/fr/formations/centre-de-formation-professionnelle-neuchatelois-cpne/designer-dobjets-horlogers-es" },
    ],
    category: "Art de l'horlogerie et de la bijouterie",
  },
  {
  ...
  },
  {
    ...
    formations: [
      { label: "Menuisier CFC : ébénisterie / Menuisière CFC : ébénisterie", url: "https://www.orientation.ch/fr/professions/menuisier-iere-cfc" },
    ],
    category: "Art du bois",
  },
  {
    ...
    formations: [
      { label: "Emailleur — émailleuse, domaine horlogerie/joaillerie", url: "https://www.orientation.ch/fr/formations/convention-patronale-de-lindustrie-horlogere-suisse-cpih/emailleur-emailleuse-domaine" },
    ],
    category: "Art de l'horlogerie et de la bijouterie",
  },
  {
    ...
    formations: [
      { label: "Technicien ES en textile et habillement / Technicienne ES en textile et habillement", url: "https://www.orientation.ch/fr/professions/technicien-ne-es-en-textile-et-habillement" },
    ],
    category: "Art du textile",
  },
  {
  ...
  },
  {
    ...
    formations: [
      { label: "Fleuriste CFC", url: "https://www.orientation.ch/fr/professions/fleuriste-cfc" },
    ],
    category: "Art de la terre",
  },
  {
    ...
    formations: [
      { label: "Facteur de piano CFC / Factrice de piano CFC", url: "https://www.orientation.ch/fr/professions/facteur-trice-de-pianos-cfc" },
    ],
  ...
  },
  {
    ...
    formations: [
      { label: "Scénographe HES", url: "https://www.orientation.ch/fr/professions/scenographe" },
      { label: "Menuisier CFC / Menuisière CFC", url: "https://www.orientation.ch/fr/professions/menuisier-iere-cfc" },
    ],
  ...
  },
  {
    ...
    formations: [
      { label: "Ferblantier CFC / Ferblantière CFC", url: "https://www.orientation.ch/fr/professions/ferblantier-iere-cfc" },
    ],
    category: "Art du métal",
  },
  {
  ...
  },
  {
    ...
    formations: [
      { label: "Artisan du cuir et du textile CFC / Artisane du cuir et du textile CFC", url: "https://www.orientation.ch/fr/professions/artisan-e-du-cuir-et-du-textile-cfc" },
    ],
    category: "Art du cuir",
  },
  {
  ...
  },
  {
    ...
    formations: [
      { label: "Horloger CFC / Horlogère CFC", url: "https://www.orientation.ch/fr/professions/horloger-ere-cfc" },
    ],
    category: "Art de l'horlogerie et de la bijouterie",
  },
  {
    ...
    formations: [
      { label: "Graveur CFC / Graveuse CFC", url: "https://www.orientation.ch/fr/professions/graveur-euse-cfc" },
    ],
    category: "Art du métal",
  },
  {
    ...
    formations: [
      { label: "Graveur CFC / Graveuse CFC", url: "https://www.orientation.ch/fr/professions/graveur-euse-cfc" },
      { label: "Gravure / sérigraphie / typographie — cours et stages", url: "https://www.orientation.ch/fr/formations/atelier-genevois-de-gravure-contemporaine/gravure-serigraphie-typographie-cours-et" },
    ],
    category: "Art du métal",
  },
  {
  ...
  },
  {
    ...
    formations: [
      { label: "Luthier CFC / Luthière CFC", url: "https://www.orientation.ch/fr/professions/luthier-iere-cfc" },
    ],
    category: "Art de la facture instrumentale",
  },
  {
    ...
    formations: [
      { label: "Maquettiste d'architecture CFC", url: "https://www.orientation.ch/fr/professions/maquettiste-darchitecture-cfc" },
    ],
    category: "Arts appliqués",
  },
  {
    ...
    formations: [
      { label: "Artisan du cuir et du textile CFC / Artisane du cuir et textile CFC", url: "https://www.orientation.ch/fr/professions/artisan-e-du-cuir-et-du-textile-cfc" },
    ],
    category: "Art du cuir",
  },
  {
    ...
    formations: [
      { label: "Tailleur de pierre CFC / Tailleuse de pierre CFC", url: "https://www.orientation.ch/fr/professions/tailleur-euse-de-pierre-cfc" },
    ],
  ...
  },
  {
    ...
    formations: [
      { label: "Souffleur de verre pour appareils scientifiques CFC / Souffleuse de verre pour appareils scientifiques CFC", url: "https://www.orientation.ch/fr/professions/souffleur-euse-de-verre-pour-appareils-scientifiques-cfc" },
    ],
  ...
  },
  {
    ...
    formations: [
      { label: "Peintre CFC", url: "https://www.orientation.ch/fr/professions/peintre-cfc" },
      { label: "Peintre en décors de théâtre CFC", url: "https://www.orientation.ch/fr/professions/peintre-en-decors-de-theatre-cfc" },
  ...
  },
  {
    ...
    formations: [
      "Opérateur en médias imprimés CFC / Opératrice en médias imprimés CFC",
      { label: "Conservateur-restaurateur HES / Conservatrice-restauratrice HES", url: "https://www.orientation.ch/fr/professions/conservateur-restaurateur-conservatrice-restauratrice" },
    ],
    category: "Art de la conservation et de la restauration",
  },
  {
    ...
    formations: [
      { label: "Sculpteur sur bois CFC / Sculptrice sur bois CFC", url: "https://www.orientation.ch/fr/professions/sculpteur-trice-sur-bois-cfc" },
      { label: "Artiste plasticien HES / Artiste plasticienne HES", url: "https://www.orientation.ch/fr/professions/artiste-plasticien-ne" },
    ],
    category: "Art du bois",
  },
  {
  ...
  },
  {
    ...
    formations: [
      { label: "Polydesigner 3D CFC", url: "https://www.orientation.ch/fr/professions/polydesigner-3d-cfc" },
      { label: "Scénographe HES", url: "https://www.orientation.ch/fr/professions/scenographe" },
    ],
    category: "Institutions culturelles",
  },
  ...
  },
  {
    ...
    formations: [
      { label: "Plâtrier constructeur à sec CFC / Plâtrière constructrice à sec CFC", url: "https://www.orientation.ch/fr/professions/platrier-iere-constructeur-trice-a-sec-cfc" },
    ],
    category: "Art de la pierre",
  },
  {
    ...
    formations: [
      { label: "Créateur de vêtements CFC / Créatrice de vêtements CFC", url: "https://www.orientation.ch/fr/professions/createur-trice-de-vetements-cfc" },
      { label: "Designer HES en design mode", url: "https://www.orientation.ch/fr/filieres-d-etudes/design" },
    ],
    category: "Art du textile",
  },
  {
    ...
    formations: [
      { label: "Sertisseur de pierres précieuses CFC / Sertisseuse de pierres précieuses CFC", url: "https://www.orientation.ch/fr/professions/sertisseur-euse-de-pierres-precieuses-cfc" },
    ],
    category: "Art de l'horlogerie et de la bijouterie",
  },
  {
    ...
    formations: [
      { label: "Tapissier-décorateur CFC / Tapissière-décoratrice CFC", url: "https://www.orientation.ch/fr/professions/tapissier-iere-decorateur-trice-cfc" },
    ],
    category: "Art du textile",
  },
  {
    ...
    formations: [
      { label: "Vitrail, verre", url: "https://www.orientation.ch/fr/formations/ecole-suisse-de-vitrail-creation/vitrail-verre-divers-cours-et-stages" },
      { label: "Verrier créateur", url: "https://www.orientation.ch/fr/formations/ecole-suisse-de-vitrail-creation/verrier-createur-verriere-creatrice" },
    ],
    category: "Art du verre",
  },
];
